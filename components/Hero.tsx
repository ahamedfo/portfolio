  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-6 pt-20">
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          <p className="text-cyan-600 font-medium mb-4">Hi, my name is</p>
        </motion.div>
        ...
        <motion.h2
          ...
          className="text-2xl md:text-4xl font-semibold text-slate-500 mb-6"
        >
          {personalInfo.title}
        </motion.h2>
        ...
        >
          ...
          <a
            href="#contact"
            className="inline-flex items-center gap-2 px-6 py-3 border-2 border-cyan-600 text-cyan-600 rounded-lg font-medium hover:bg-cyan-50 transition-colors"
          >
            Get in Touch
          </a>
        </motion.div>
