    ...
    <section id="contact" className="py-24 px-6">
      <div className="max-w-4xl mx-auto text-center" ref={ref}>
        ...
        >
          ...
          or interesting projects at the intersection of AI and security.
        </motion.p>
        ...
        >
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-6 py-3 border-2 border-slate-300 text-slate-700 rounded-lg font-medium hover:border-cyan-600 hover:text-cyan-600 transition-colors"
          >
